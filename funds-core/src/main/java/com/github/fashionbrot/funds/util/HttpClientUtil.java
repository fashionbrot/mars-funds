...
public class HttpClientUtil {
    ...
    public static  HttpResult httpGet(String url, List<String> headers, List<String> paramValues){
        return httpGet(url,headers,paramValues, MarsConst.ENCODE_UTF8,5000,5000);
    }
    ...
    public static  HttpResult httpPost(String url, List<String> headers, List<String> paramValues) {
        return httpPost(url, headers, paramValues, MarsConst.ENCODE_UTF8, 5000,5000);
    }
    ...
    private static  String toString(InputStream input, String encoding) throws Exception {
        return CharStreamUtil.toString(new InputStreamReader(input,encoding==null? MarsConst.ENCODE_UTF8:encoding));
    }
